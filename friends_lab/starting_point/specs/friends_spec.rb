...
class TestFriends < MiniTest::Test
  ...
  def test_adds_friend
    result = adds_friend(@person2, "Bob")
  ...
  def test_find_total_monuies
    result = find_total_monies(@people)
...
def test_adds_all_favourite_foods
  result = adds_all_favourite_foods(@people)
  expectation = ["charcuterie", "soup", "bread", "Scooby snacks", "spaghetti", "ratatouille", "spinach"]
